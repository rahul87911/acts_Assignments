...
class ClassCountercomponent extends React.Component{
    ...
    /*static getDerivedStateFromProps(nextprops,prevstate){
        console.log("in getDerivedStateFrom props")
        return {
            count:0
        };
    }*/
    shouldComponentUpdate(){
        console.log("in shouldcomponentupdate props")
        return true;
    }
    componentDidMount(){
        //is a best place to use API calls to initialize state
        console.log("in Counter component componentdidmount")
    }
    getSnapshotBeforeUpdate(){
        console.log("in getsnapshotbeforeupdate")
    }
    componentDidUpdate(prevprops,prevstate){
        console.log("componentdidupdate counter component")
